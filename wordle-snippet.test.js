...
//
//  Version: 1.0 (9th Feb 2021) - working prototype
//
...
I.see("Guess the WORDLE in 6 tries")

// Click on somewhere on the top left screen, 
...
//--------------------------------------------------------
//
//  The following function, help get the current wordle
//  state. This is used to feed the guessing engine
//
//--------------------------------------------------------
...
function runTheWordleSolver() {
	// Lets load the wordle solver, with the dictionary list
	// the class and function definition will be shown later below
 ...
 *
 * # Format of the returned state obejct
 *
...
function getWordleStateFromUI() {
	// We execute a function inside the browser to return the respective info
	let ret = UI.execute$$(function() {
		// This is execute inside the browser ...
...
//--------------------------------------------------------
//
// The WORDLE Solver Class (the guessing engine)
//
//--------------------------------------------------------
